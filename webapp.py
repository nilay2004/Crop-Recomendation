...
img = Image.open("KRISHI/CROP-RECOMMENDATION/crop.png")
# display image using streamlit
# width is used to set the width of an image
st.image(img)

df= pd.read_csv('KRISHI/CROP-RECOMMENDATION/Crop_recommendation.csv')
...
RF_pkl_filename = 'KRISHI/CROP-RECOMMENDATION/RF.pkl'
